...
public class QuestionController {
    ...
    public String questionDetail(Model model, @PathVariable int id, AnswerSaveDto answerSaveDto, CommentForm commentForm) {
        QuestionContainAnswerDto questionDto = boardService.getQuestionDetail(id);
